            ...
            <a-row :gutter="24">
              ...
              <a-col span="12">
                <a-form-item label="品种">
                  <a-input placeholder="请输入"  v-model:value="modal.form.pinzhong" style="width: 100%" />
                </a-form-item>
              </a-col>
              <a-col span="12">
                <a-form-item label="保质期">
                  <a-input placeholder="请输入" v-model:value="modal.form.baozhiqi" style="width: 100%" />
                </a-form-item>
              </a-col>
              <a-col span="12">
                <a-form-item label="生产日期">
                  <a-input placeholder="请输入" v-model:value="modal.form.shengchanriqi" style="width: 100%" />
                </a-form-item>
              </a-col>
              <a-col span="12">
  ...
  const handleOk = () => {
    myform.value
      ...
      .then(() => {
        ...
        formData.append('pinzhong', modal.form.pinzhong || '');
        formData.append('baozhiqi', modal.form.baozhiqi || '');
        formData.append('shengchanriqi', modal.form.shengchanriqi || '');
