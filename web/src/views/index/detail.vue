    ...
    <div class="detail-content">
      <div class="detail-content-top">
        ...
        <div class="top-right">
          ...
          <div class="meta">品种：{{ detailData.pinzhong }}</div>
          <div class="meta">库存：{{ detailData.repertory }}</div>
          <div class="meta">保质期：{{ detailData.baozhiqi }}</div>
          <div class="meta">生产日期：{{ detailData.shengchanriqi }}</div>
          <div class="actions">
